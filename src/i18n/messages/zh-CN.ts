export default {
  ...
  pages: {
    ...
    hermesMemory: {
      ...
      sections: {
        featureToggles: '功能开关',
        featureTogglesDesc: '控制记忆和用户画像功能的启用状态',
        capacityLimits: '容量限制',
        capacityLimitsDesc: '设置记忆和用户画像的最大字符数',
        providerConfig: 'Provider 配置',
        providerConfigDesc: '选择用于记忆处理的 AI 服务提供商',
      },
      validation: {
    ...
    hermesCli: {
      ...
      launch: '启动',
      defaultConfigHint: '使用默认配置快速启动，或自定义模型和 Provider',
      showAdvanced: '显示高级选项',
      hideAdvanced: '隐藏高级选项',
