  ...
  pages: {
    ...
    hermesMemory: {
      ...
      sections: {
        ...
        featureTogglesDesc: 'Control the enabled state of memory and user profile features',
        capacityLimits: 'Capacity Limits',
        capacityLimitsDesc: 'Set the maximum character count for memory and user profile',
        providerConfig: 'Provider Configuration',
        providerConfigDesc: 'Select the AI service provider for memory processing',
      },
      validation: {
    ...
    hermesCli: {
      ...
      launch: 'Launch',
      defaultConfigHint: 'Quick launch with defaults, or customize model and provider',
